...
export const handleCustomError = (err: any): [string, number] => {
  ...
  switch (err.code) {
    ...
    case E_CUSTOM_ERROR_CODES.TEACHER_REQS_DATE_CONFLICT:
      return [message, HttpStatus.BAD_REQUEST];
    case E_CUSTOM_ERROR_CODES.SCHEDULE_CONFLICT:
    case E_CUSTOM_ERROR_CODES.TEACHER_REQS_CONFLICT:
    case E_CUSTOM_ERROR_CODES.TEACHER_HAS_SCHEDULE:
    case E_CUSTOM_ERROR_CODES.GUARANTOR_TEACHER_CHECK:
    case E_CUSTOM_ERROR_CODES.ROLES_TEACHER_HAS_SCHEDULE:
    case E_CUSTOM_ERROR_CODES.ROLES_GUARANTOR_HAS_COURSES:
    case E_CUSTOM_ERROR_CODES.ROLES_STUDENT_HAS_COURSES:
